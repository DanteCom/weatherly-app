...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/moon_cloud_fast_wind.png
  AssetGenImage get moonCloudFastWind =>
      const AssetGenImage('assets/images/moon_cloud_fast_wind.png');
  ...
  /// File path: assets/images/starry_sky_bg.jpg
  AssetGenImage get starrySkyBg =>
      const AssetGenImage('assets/images/starry_sky_bg.jpg');
...
class $AssetsSvgsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [list, location];
}
